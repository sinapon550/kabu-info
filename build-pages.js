...
const DATA = [
  ...
  { file: "asml.html", name: "ASML", code: "ASML／蘭", ticker: "ASML", emoji: "🔬",
    ...
    strengths: ["EUV露光装置を<b>事実上独占</b>", "1台数百億円の高付加価値、参入不可能レベルの技術"],
    risks: ["対中輸出規制など<b>地政学リスク</b>", "半導体の設備投資サイクルに業績が左右される"],
  ...
  { file: "tokyo-electron.html", name: "東京エレクトロン", code: "8035", ticker: "8035.T", emoji: "🏭",
    ...
    strengths: ["多くの工程で<b>高シェア</b>", "AIチップ・先端パッケージの装置需要を総取り"],
    risks: ["半導体の設備投資サイクル", "対中規制の影響"],
  ...
  { file: "lasertec.html", name: "レーザーテック", code: "6920", ticker: "6920.T", emoji: "🔍",
    ...
    strengths: ["EUVマスク検査を<b>独占的に</b>担う", "最先端化が進むほど需要が増える"],
    risks: ["特定分野・特定客への依存度が高い", "株価の変動が大きい（人気化しやすい）"],
  ...
  { file: "disco.html", name: "ディスコ", code: "6146", ticker: "6146.T", emoji: "🪚",
    ...
    strengths: ["ダイシング/研削で<b>高シェア</b>", "高収益体質"],
    risks: ["半導体市況・設備投資サイクル", "株価の期待が高め"],
  ...
  { file: "shinetsu.html", name: "信越化学", code: "4063", ticker: "4063.T", emoji: "🧪",
    ...
    strengths: ["シリコンウエハー世界トップ級＋<b>多角化で安定</b>", "高収益・好財務"],
    risks: ["半導体・化学市況の影響", "為替の影響"],
  ...
  { file: "sumco.html", name: "SUMCO", code: "3436", ticker: "3436.T", emoji: "🧪",
    ...
    strengths: ["ウエハーで世界2位級のシェア", "AI向け大口径ウエハーの需要"],
    risks: ["ウエハー市況の波（在庫調整）", "設備投資の負担"],
  ...
  { file: "rohm.html", name: "ローム", code: "6963", ticker: "6963.T", emoji: "⚡",
    ...
    strengths: ["SiCパワー半導体に<b>早くから投資</b>", "電子部品も幅広い"],
    risks: ["車載・産業の景気変動", "SiCの価格競争が激化"],
  ...
  { file: "screen.html", name: "SCREEN HD", code: "7735", ticker: "7735.T", emoji: "🚿",
    ...
    strengths: ["ウエハー洗浄で<b>世界トップ</b>", "微細化の進展が追い風"],
    risks: ["半導体市況の波", "主力一本足のリスク"],
  ...
  { file: "resonac.html", name: "レゾナック", code: "4004", ticker: "4004.T", emoji: "🧱",
    ...
    strengths: ["後工程材料で<b>世界的シェア</b>", "AI先端パッケージ材料の需要"],
    risks: ["化学事業の市況変動", "事業再編の途上"],
  ...
  { file: "nhk-spring.html", name: "日本発条", code: "5991", ticker: "5991.T", emoji: "🔩",
    ...
    strengths: ["ばねで<b>世界トップ級</b>＋HDD精密部品", "配当もある安定・実業系"],
    risks: ["自動車生産の変動", "急成長テーマではない（地味）"],
  ...
  { file: "fanuc.html", name: "ファナック", code: "6954", ticker: "6954.T", emoji: "🦾",
    ...
    strengths: ["産業用ロボット・CNCで<b>世界トップ級</b>", "高い技術力とブランド"],
    risks: ["設備投資の景気変動", "中国市場の動向"],
  ...
  { file: "murata.html", name: "村田製作所", code: "6981", ticker: "6981.T", emoji: "🔌",
    ...
    strengths: ["MLCCで<b>世界トップ</b>", "電子機器が増えるほど需要増"],
    risks: ["スマホ市況の影響", "価格競争"],
  ...
  { file: "yaskawa.html", name: "安川電機", code: "6506", ticker: "6506.T", emoji: "🤖",
    ...
    strengths: ["サーボモーターで世界高シェア", "ロボット事業の成長"],
    risks: ["設備投資の景気変動", "中国市場の動向"],
  ...
  { file: "keyence.html", name: "キーエンス", code: "6861", ticker: "6861.T", emoji: "📷",
    ...
    strengths: ["<b>営業利益率5割級</b>の超高収益", "提案型営業の強さ"],
    risks: ["設備投資の景気変動", "株価が高水準（期待大）"],
  ...
  { file: "harmonic.html", name: "ハーモニック", code: "6324", ticker: "6324.T", emoji: "⚙️",
    ...
    strengths: ["精密減速機で<b>高シェア</b>", "ヒューマノイド普及の恩恵期待"],
    risks: ["需要の振れが大きい", "期待先行で株価変動大"],
  ...
  { file: "sandisk.html", name: "SanDisk", code: "SNDK／米", ticker: "SNDK", emoji: "💾",
    ...
    strengths: ["NANDで世界上位（キオクシア連合）", "AIサーバー向けSSD需要"],
    risks: ["<b>シリコンサイクル</b>（メモリの波）", "DRAM/HBMはやらないNAND一本足"],
  ...
  { file: "sk-hynix.html", name: "SKハイニックス", code: "000660／韓国", ticker: "000660.KS", emoji: "💾",
    ...
    strengths: ["<b>HBMで世界首位</b>、NVIDIAに供給", "AI需要を直接取り込む"],
    risks: ["シリコンサイクル（メモリの波）", "HBM競争（サムスン・Micron）"],
  ...
  { file: "samsung.html", name: "サムスン電子", code: "005930／韓国", ticker: "005930.KS", emoji: "📱",
    ...
    strengths: ["メモリ世界1位＋<b>事業の幅広さ</b>", "巨大な生産・投資力"],
    risks: ["HBMでSKハイニックスに先行された", "シリコンサイクル・スマホ市況"],
  ...
  { file: "mufg.html", name: "三菱UFJ", code: "8306", ticker: "8306.T", emoji: "🏦",
    ...
    strengths: ["国内最大の<b>規模と信用力</b>", "金利上昇で収益改善＋厚めの配当"],
    risks: ["景気後退・貸し倒れ", "金利・為替の変動"],
  ...
  { file: "softbank.html", name: "ソフトバンク", code: "9434", ticker: "9434.T", emoji: "📱",
    ...
    strengths: ["通信の<b>安定収益</b>＋高めの配当", "PayPay・法人AIなど成長分野も"],
    risks: ["通信料金の競争・規制", "成長は緩やか"],
  ...
  { file: "asahi.html", name: "アサヒGHD", code: "2502", ticker: "2502.T", emoji: "🍺",
    ...
    strengths: ["強いブランド（スーパードライ）", "海外展開＋値上げ浸透"],
    risks: ["原材料・為替の影響", "国内の人口減・酒類需要の伸び悩み"],
  ...
  { file: "sojitz.html", name: "双日", code: "2768", ticker: "2768.T", emoji: "🌐",
    ...
    strengths: ["事業の<b>分散</b>で安定", "株主還元の強化"],
    risks: ["資源価格・景気の変動", "大手商社より規模は小さい"],
  ...
  { file: "jt.html", name: "日本たばこ産業(JT)", code: "2914", ticker: "2914.T", emoji: "🚬",
    ...
    strengths: ["<b>高い配当利回り</b>", "海外たばこの安定収益"],
    risks: ["たばこ規制・健康志向", "為替の影響"],
  ...
  { file: "nxera.html", name: "ネクセラファーマ", code: "4565", ticker: "4565.T", emoji: "💊",
    ...
    strengths: ["独自の創薬技術", "大手製薬との提携収入"],
    risks: ["<b>新薬開発は不確実</b>（失敗リスク）", "値動きが大きく業績も振れやすい"],
  ...
  { file: "rakuten.html", name: "楽天グループ", code: "4755", ticker: "4755.T", emoji: "🛒",
    ...
    strengths: ["巨大な<b>楽天経済圏</b>", "金融事業は好調"],
    risks: ["<b>モバイルの赤字・借入</b>", "競争が激しい"],
  ...
  { file: "honda.html", name: "本田技研工業", code: "7267", ticker: "7267.T", emoji: "🏍️",
    ...
    strengths: ["バイク世界トップ＋北米の強さ", "株主還元に積極的"],
    risks: ["EV化への対応・競争", "為替・関税の影響"],
  ...
  { file: "mitsubishi-corp.html", name: "三菱商事", code: "8058", ticker: "8058.T", emoji: "🌐",
    ...
    strengths: ["<b>事業の幅広さ</b>で安定", "高配当・株主還元"],
    risks: ["資源価格・景気の変動", "為替の影響"],
  ...
  { file: "aeon.html", name: "イオン", code: "8267", ticker: "8267.T", emoji: "🛒",
    ...
    strengths: ["巨大な<b>生活インフラ</b>網", "金融・モールなど多角化"],
    risks: ["<b>利益率が薄い</b>（薄利多売）", "物価・人件費の上昇"],
  ...
  { file: "orix.html", name: "オリックス", code: "8591", ticker: "8591.T", emoji: "💴",
    ...
    strengths: ["<b>多角経営で安定</b>", "配当・優待の人気"],
    risks: ["景気・金利の変動", "事業が幅広く分かりにくい"],
  ...
  { file: "sony-fg.html", name: "ソニーフィナンシャルG", code: "8729", ticker: "8729.T", emoji: "🛡️",
    ...
    strengths: ["生保中心で<b>安定</b>", "ソニーブランド"],
    risks: ["金利・運用環境の変動", "保険市場の競争"],
  ...
  { file: "ntt.html", name: "NTT", code: "9432", ticker: "9432.T", emoji: "📡",
    ...
    strengths: ["<b>超安定</b>の通信インフラ", "高配当＋買いやすさ"],
    risks: ["通信料金の競争・規制", "成長は緩やか"],
  ...
  { file: "kddi.html", name: "KDDI", code: "9433", ticker: "9433.T", emoji: "📶",
    ...
    strengths: ["通信の<b>安定収益</b>＋高配当", "金融・DXなど多角化"],
    risks: ["通信料金の競争・規制", "成長は緩やか"],
  ...
  { file: "mirait.html", name: "ミライト・ワン", code: "1417", ticker: "1417.T", emoji: "🏗️",
    ...
    strengths: ["通信インフラ工事の<b>実績</b>", "5G・DC・再エネで需要"],
    risks: ["工事案件の変動", "人手不足・コスト上昇"],
  ...
  { file: "openai.html", name: "OpenAI", code: "非上場／米", ticker: "", emoji: "🤖",
    ...
    strengths: ["生成AIの<b>知名度・先行</b>", "Microsoft・ソフトバンクG等の強力な後ろ盾"],
    risks: ["<b>非上場で直接投資できない</b>", "巨額の投資・競争（Anthropic等）"],
  ...
  { file: "anthropic.html", name: "Anthropic", code: "非上場／米", ticker: "", emoji: "🛡️",
    ...
    strengths: ["<b>急成長</b>（評価額でOpenAI超え）", "Amazon・Googleの出資"],
    risks: ["<b>非上場で直接投資できない</b>", "AI開発の巨額コスト・競争"],
