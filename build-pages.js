...
const DATA = [
  ...
  // ===== テーマ株（半導体基板・電力・DC・防衛・サイバー）=====
  { file: "ibiden.html", name: "イビデン", code: "4062", ticker: "4062.T", emoji: "🧱",
    lead: "AIサーバー向け半導体パッケージ基板の世界トップ級「イビデン（4062）」。",
    aboutTitle: "🧱 チップを載せる“土台”基板の王者",
    about: "高性能チップを載せる<b>ICパッケージ基板（FC-BGA）</b>で世界トップ級の岐阜の会社。AIサーバーのCPU/GPUに不可欠で、<b>需要に供給が追いつかない</b>分野。元はセラミック・プリント基板の技術が源流。",
    strengths: ["FC-BGA基板で<b>世界トップ級シェア</b>", "AIサーバー向けで需要が逼迫", "高い技術障壁（参入が難しい）"],
    risks: ["<b>巨額の設備投資</b>負担", "特定の大口顧客への依存", "半導体市況・在庫調整の波"],
    outlook: ["<b>AI・データセンター向けFC-BGA</b>の需要拡大", "次世代パッケージ（大型化）への投資"] },
  { file: "fujikura.html", name: "フジクラ", code: "5803", ticker: "5803.T", emoji: "🔌",
    lead: "データセンター向け光配線で大化けした電線大手「フジクラ（5803）」。",
    aboutTitle: "🔌 電線・光ファイバーのテーマ本命格",
    about: "電線・<b>光ファイバー</b>の大手。AIデータセンター内の高速通信に使う<b>光コネクタ・光配線</b>の需要が急増し、テーマ株の本命格として株価が大きく上昇した。",
    strengths: ["DC向け<b>光配線・コネクタ</b>に強い", "AIインフラ拡大の直接的な恩恵", "事業構造改革で収益力が向上"],
    risks: ["<b>株価の期待が高い</b>（過熱しやすい）", "データセンター投資のサイクル", "銅・材料価格の変動"],
    outlook: ["<b>北米AIデータセンター</b>向けの需要", "光技術の高速化ニーズ"] },
  { file: "sumitomo-electric.html", name: "住友電工", code: "5802", ticker: "5802.T", emoji: "⚡",
    lead: "電線・送電インフラの総合大手「住友電気工業（5802）」。",
    aboutTitle: "⚡ 電線・送電網・車載まで幅広い素材メーカー",
    about: "<b>電線・送電インフラ</b>、自動車の配線（ワイヤーハーネス）、光ファイバーなどを幅広く手がける総合大手。電化と送電網の更新で<b>息の長い需要</b>がある。",
    strengths: ["送電インフラ・電線で<b>厚い実績</b>", "事業が幅広く<b>分散が効く</b>", "電化トレンドの恩恵"],
    risks: ["自動車（ハーネス）の景気変動", "銅価格・為替の影響", "幅広いゆえに利益率は控えめ"],
    outlook: ["<b>送電網の増強・更新</b>投資", "データセンター電力・車載電動化"] },
  { file: "chubu-electric.html", name: "中部電力", code: "9502", ticker: "9502.T", emoji: "💡",
    lead: "中部地方の電力会社、安定インフラ＋配当「中部電力（9502）」。",
    aboutTitle: "💡 生活と産業を支える電力インフラ",
    about: "中部地方に電気を届ける<b>電力会社</b>。生活に不可欠なインフラで<b>業績が安定</b>、配当狙いに向く。データセンター誘致など<b>電力需要の増加</b>が追い風になりうる。",
    strengths: ["インフラで<b>業績が安定</b>", "<b>高めの配当</b>", "電力需要増（DC・電化）の恩恵"],
    risks: ["<b>燃料価格</b>の変動が利益を左右", "電気料金は規制の影響を受ける", "原発（浜岡）再稼働の不透明さ"],
    outlook: ["<b>データセンター・電化</b>で電力需要増", "安定配当の継続"] },
  { file: "hitachi.html", name: "日立製作所", code: "6501", ticker: "6501.T", emoji: "🏭",
    lead: "送配電・鉄道・DXに強い総合電機の巨人「日立製作所（6501）」。",
    aboutTitle: "🏭 “選択と集中”で生まれ変わった総合電機",
    about: "事業再編を進めて高収益化した総合電機。<b>送配電（Hitachi Energy）</b>・鉄道・IT（Lumada）が柱で、<b>電力網とデジタルの両テーマ</b>に乗れる総合力が強み。",
    strengths: ["<b>送電網（Hitachi Energy）</b>の世界的需要", "事業再編で<b>収益力アップ</b>", "DX（Lumada）の成長"],
    risks: ["景気敏感な事業を含む", "巨大すぎて分かりにくい", "海外比率が高く為替の影響"],
    outlook: ["<b>世界的な送電網投資</b>の恩恵", "AI・DXでデジタル事業が拡大"] },
  { file: "sakura.html", name: "さくらインターネット", code: "3778", ticker: "3778.T", emoji: "☁️",
    lead: "国産クラウド・生成AI基盤で注目「さくらインターネット（3778）」。",
    aboutTitle: "☁️ 国産クラウド・データセンターの注目株",
    about: "国産の<b>クラウド・データセンター</b>事業者。政府の<b>ガバメントクラウド</b>に選ばれ、<b>生成AI向けのGPUクラウド</b>で急成長して人気化した。",
    strengths: ["<b>国産クラウド</b>の代表格", "生成AI向けGPU基盤で需要", "政府・公共の後押し"],
    risks: ["<b>規模が小さく値動きが荒い</b>", "GPU等への巨額投資が先行", "大手クラウド（AWS等）との競争"],
    outlook: ["<b>国産生成AI基盤</b>の中核を狙う", "GPUクラウドの増強"] },
  { file: "kandenko.html", name: "関電工", code: "1942", ticker: "1942.T", emoji: "🔧",
    lead: "電気設備工事の大手、DC建設の受け皿「関電工（1942）」。",
    aboutTitle: "🔧 電気を“つなぐ”工事の大手",
    about: "ビルや<b>データセンター</b>、送配電などの<b>電気設備工事</b>を手がける大手（関東地盤）。DC建設ラッシュや再エネで<b>工事需要が増えている</b>。",
    strengths: ["電気工事の<b>実績と体制</b>", "<b>データセンター建設</b>の受け皿", "再エネ・電化の工事需要"],
    risks: ["人手不足・<b>労務費の上昇</b>", "案件の時期で業績が振れる", "資材高が採算を圧迫"],
    outlook: ["<b>データセンター・AIインフラ</b>の工事拡大", "送配電網の更新工事"] },
  { file: "mhi.html", name: "三菱重工業", code: "7011", ticker: "7011.T", emoji: "🛡️",
    lead: "防衛の中核＋発電も担う重工最大手「三菱重工業（7011）」。",
    aboutTitle: "🛡️ 防衛とエネルギーの二枚看板",
    about: "戦闘機・艦艇・ミサイルなど<b>防衛装備の中核</b>を担う重工最大手。<b>発電設備（ガスタービン・原子力）</b>も大きく、防衛費増額とエネルギー需要の両方に乗れる。",
    strengths: ["<b>防衛の本命</b>（装備の中核）", "発電設備で<b>もう一本の柱</b>", "防衛費増額という追い風"],
    risks: ["防衛は<b>政策・予算次第</b>", "大型案件の採算管理", "海外比率が高く為替の影響"],
    outlook: ["<b>防衛費の増額</b>（2027年度まで強化）", "原子力回帰・GXで発電需要"] },
  { file: "kawasaki-hi.html", name: "川崎重工業", code: "7012", ticker: "7012.T", emoji: "🚢",
    lead: "潜水艦・航空エンジン・水素の重工大手「川崎重工業（7012）」。",
    aboutTitle: "🚢 防衛と水素に強い重工大手",
    about: "<b>潜水艦・哨戒機・ヘリ</b>などの防衛と、航空機エンジン、<b>水素エネルギー</b>を手がける重工大手。防衛増額に加え、将来の水素社会を見据えた投資が特徴。",
    strengths: ["防衛（<b>潜水艦・航空</b>）の実績", "航空エンジンの世界的な分担生産", "<b>水素</b>で先行投資"],
    risks: ["大型案件の<b>採算ブレ</b>", "景気敏感な事業を含む", "水素の本格収益化は時間がかかる"],
    outlook: ["<b>防衛費の増額</b>", "航空回復・水素エネルギーの将来性"] },
  { file: "ihi.html", name: "IHI", code: "7013", ticker: "7013.T", emoji: "✈️",
    lead: "航空エンジンと防衛に強い重工「IHI（7013）」。",
    aboutTitle: "✈️ 航空エンジンと防衛の重工",
    about: "民間・防衛向けの<b>航空機エンジン</b>に強い重工。防衛（エンジン・弾薬）や宇宙も手がける。<b>航空需要の回復と防衛増額</b>が業績の追い風。",
    strengths: ["<b>航空エンジン</b>の高い技術", "防衛増額の恩恵", "アフターサービス（整備）の安定収益"],
    risks: ["航空市況の影響", "過去に品質・採算の問題も", "大型開発の負担"],
    outlook: ["<b>航空エンジン需要</b>の回復", "防衛費の増額"] },
  { file: "trendmicro.html", name: "トレンドマイクロ", code: "4704", ticker: "4704.T", emoji: "🔐",
    lead: "日本発のグローバル総合セキュリティ「トレンドマイクロ（4704）」。",
    aboutTitle: "🔐 法人向けに強い総合セキュリティ",
    about: "ウイルス対策で知られる<b>日本発のセキュリティ大手</b>。今は<b>法人向け（クラウド・サーバー・エンドポイント）</b>が主力で、サブスク型の<b>安定した収益</b>が魅力。",
    strengths: ["<b>法人セキュリティ</b>の実績とブランド", "サブスクで<b>収益が安定</b>", "比較的<b>高めの配当</b>"],
    risks: ["米国勢との<b>競争が激しい</b>", "海外比率が高く為替の影響", "成長スピードは穏やか"],
    outlook: ["<b>クラウドセキュリティ</b>の需要拡大", "AIを使った防御の高度化"] },
  { file: "digitalarts.html", name: "デジタルアーツ", code: "2326", ticker: "2326.T", emoji: "🛡️",
    lead: "官公庁・学校に強い情報フィルタリング「デジタルアーツ（2326）」。",
    aboutTitle: "🛡️ “見せない・出さない”を守る国産セキュリティ",
    about: "有害サイトや情報漏えいを防ぐ<b>情報フィルタリング（i-FILTER）</b>の国産大手。<b>官公庁・学校・企業</b>に強く、国のセキュリティ強化で需要が伸びる。<b>高収益・好財務</b>。",
    strengths: ["<b>官公庁・教育に強い</b>", "<b>高い利益率</b>と良好な財務", "国のセキュリティ投資の後押し"],
    risks: ["<b>国内市場が中心</b>（成長の天井）", "官公庁の予算・入札に左右される", "競合の参入"],
    outlook: ["<b>ゼロトラスト</b>など防御強化の流れ", "官公庁・自治体のセキュリティ投資"] },
  // ===== 非上場AI =====
